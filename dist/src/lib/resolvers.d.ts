...
export declare function ralativeAddonImport(templateFileName: string, addonItemFileName: string): string | null;
export declare function relativeComponentImport(templateFileName: string, scriptForComponent: string): string | null;
export declare function findComponentForTemplate(fsPath: any, projectRoot: any): string | null;
